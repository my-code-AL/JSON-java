...
public class XMLTest {
    ...
    public void contentOperations() {
         ...
         * If there is only one instance, it is saved in the context (a different
         * JSONObject
    ...
    public void testToJSONArray_jsonOutput() {
        ...
        final JSONObject expectedJson = new JSONObject(
                "{\"root\":{\"item\":{\"id\":1},\"id\":[1,1,0,0],\"title\":true}}");
    ...
    public void testMaxNestingDepthOf42IsRespected() {
        ...
        try {
            XML.toJSONObject(wayTooLongMalformedXML,
                    XMLParserConfiguration.ORIGINAL.withMaxNestingDepth(maxNestingDepth));
     ...
     * it checks to see if the subObject key has been placed within the xmlString
     * and
